...
module frame_renderer #(
    ...
    input  wire [35:0] test_mc_bcd,        // match count in 9-digit BCD (clk)
    ...
    reg [35:0] tmc_meta_ff,  tmc_sync_ff;
    ...
    always @(posedge ui_clk) begin
        ...
        tmc_meta_ff   <= test_mc_bcd;
        tmc_sync_ff   <= tmc_meta_ff;
    ...
    wire [3:0] mc_fnz  = first_nz(tmc_sync_ff);
    ...
    always @(*) begin
        ...
        if (is_test_results) begin
            if (is_line0) begin
                ...
                if (test_pass) begin
                    // "  COMPARED:DDDDD   " (dynamic match count at pos 11-15)
                    case (char_a_pos)
                        ...
                        5'd12: begin // mc digit 3 (thousands)
                            if (4'd3 > mc_fnz) test_ovr_a = 7'd0;
                            else test_ovr_a = {3'd0, bcd9_val(tmc_sync_ff, 4'd3)} + 7'h30;
                        end
                        5'd14: begin // mc digit 1 (tens)
                            if (4'd1 > mc_fnz) test_ovr_a = 7'd0;
                            else test_ovr_a = {3'd0, bcd9_val(tmc_sync_ff, 4'd1)} + 7'h30;
                        end
                        default: test_ovr_a = 7'd0;
                    endcase
                    case (char_b_pos)
                        ...
                        5'd11: begin // mc digit 4 (ten-thousands)
                            if (4'd4 > mc_fnz) test_ovr_b = 7'd0;
                            else test_ovr_b = {3'd0, bcd9_val(tmc_sync_ff, 4'd4)} + 7'h30;
                        end
                        5'd13: begin // mc digit 2 (hundreds)
                            if (4'd2 > mc_fnz) test_ovr_b = 7'd0;
                            else test_ovr_b = {3'd0, bcd9_val(tmc_sync_ff, 4'd2)} + 7'h30;
                        end
                        5'd15: begin // mc digit 0 (ones)
                            test_ovr_b = {3'd0, bcd9_val(tmc_sync_ff, 4'd0)} + 7'h30;
                        end
                    ...
                    endcase
                    case (char_b_pos)
                        5'd1:  test_ovr_b = 7'h53; // S
                        5'd3:  test_ovr_b = 7'h3A; // :
                        default: begin
