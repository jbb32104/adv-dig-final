...
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports DP_n]
...
set_property PULLTYPE PULLDOWN [get_ports JA1]
set_property PULLTYPE PULLDOWN [get_ports JA2]
set_property PULLTYPE PULLDOWN [get_ports JA7]
set_property PULLTYPE PULLDOWN [get_ports JA8]
...
## SD card clock (clk_sd from PLL CLKOUT1) is asynchronous to the 100 MHz logic domain
set_clock_groups -asynchronous \
    -group [get_clocks sys_clk_pin] \
    -group [get_clocks -of_objects [get_pins u_pll/inst/mmcm_adv_inst/CLKOUT1]]
