...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { cpu_rst_n }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
...
set_property PULLDOWN true [get_ports { JA2 }]
set_property PULLDOWN true [get_ports { JA7 }]
set_property PULLDOWN true [get_ports { JA8 }]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets CPU_RESETN_IBUF];