## Constraints for sd_test_top on Nexys A7-100T
...
## The PLL-generated clk_sd is asynchronous to the board 100 MHz input
## for the purposes of our CDC logic. Vivado auto-constrains the PLL
## output clocks, so we just declare the async relationship.
